...
type Container struct {
	...
	containerInfo *dockerType.ContainerJSON
	imageInfo     *dockerType.ImageInspect
}

// NewContainer returns a new Container instance instantiated with the
// specified ContainerInfo and ImageInfo structs.
func NewContainer(containerInfo *dockerType.ContainerJSON, imageInfo *dockerType.ImageInspect) *Container {
	return &Container{
...
func (c Container) ContainerInfo() *dockerType.ContainerJSON {
...
func (c Container) ImageInfo() *dockerType.ImageInspect {
	return c.imageInfo
}
